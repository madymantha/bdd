    ...
    public void refundAndRestock(Scene s) throws Exception {
        s.
                ...
                and("I have three black sweaters in stock",
                        () -> assertTrue(s.state.<StoreFront>val("store").getBlacks() == 3,
                ...
                then("I should have four black sweaters in stock",
                        () -> assertTrue(s.state.<StoreFront>val("store").getBlacks() == 4,
    ...
    public void replaceAndRestock(Scene s) throws Exception {
        s.
                ...
                and("I have two blue garments in stock",
                        () -> assertTrue(s.state.<StoreFront>val("store").getBlues() == 2,
                ...
                then("I should have three blue garments in stock",
                        () -> assertTrue(s.state.<StoreFront>val("store").getBlues() == 3,
                                "Store should carry 3 blue garments")).

                and("two black garments in stock",
                        () -> assertTrue(s.state.<StoreFront>val("store").getBlacks() == 2,
